...
args = dotdict({
    ...
    'numMCTSSims': 12,          # Number of games moves for MCTS to simulate.
    'arenaCompare': 1000,         # Number of games to play during arena play to determine if new net will be accepted.
    'cpuct': 1,
